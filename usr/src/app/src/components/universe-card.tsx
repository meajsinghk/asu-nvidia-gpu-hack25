...
export function UniverseCard({ universe }: { universe: UniverseOutcome }) {
  return (
    <div className={cn(
        ...
        "shadow-[0_0_10px_rgba(0,192,255,0.1)] hover:border-primary/50 hover:shadow-[0_0_20px_rgba(var(--primary-hsl),0.3)]"
        )}
        style={{ '--primary-hsl': '43 98% 58%' } as React.CSSProperties}
    >
       {/* Corner accents */}
