...
export default function SimulationPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-slate-950 text-white overflow-y-auto font-sans">
      ...
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2240%22%20height%3D%2240%22%20viewBox%3D%220%200%2040%2040%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cg%20fill%3D%22%230891b2%22%20fill-opacity%3D%220.1%22%3E%3Cpath%20d%3D%22M0%2038.59l2.83-2.83%201.41%201.41L1.41%2040H0v-1.41zM0%201.4l2.83%202.83%201.41-1.41L1.41%200H0v1.41zM38.59%2040l-2.83-2.83%201.41-1.41L40%2038.59V40h-1.41zM40%201.41l-2.83%202.83-1.41-1.41L38.59%200H40v1.41zM20%2018.6l2.83-2.83%201.41%201.41L21.41%2020l2.83%202.83-1.41%201.41L20%2021.41l-2.83%202.83-1.41-1.41L18.59%2020l-2.83-2.83%201.41-1.41L20%2018.59z%22%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E')] opacity-50"></div>
        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col gap-8">
            ...
            <div className="text-center">
                 <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-cyan-300 drop-shadow-[0_2px_4px_rgba(0,192,255,0.4)]">
                    Multiverse Simulation Terminal
                </h1>
                ...
                <div className="lg:col-span-3">
                    <HudPanel className="min-h-full">
                        ...
                        <div className="space-y-4">
                            ...
                            {error && (
                                <div className="text-center py-20 flex flex-col items-center text-red-400">
